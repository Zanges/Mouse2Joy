...
public sealed class KeyCaptureBox : TextBox
{
    ...
    {
        Key.F1 => (0x3B, false), Key.F2 => (0x3C, false), Key.F3 => (0x3D, false), Key.F4 => (0x3E, false),
        Key.F5 => (0x3F, false), Key.F6 => (0x40, false), Key.F7 => (0x41, false), Key.F8 => (0x42, false),
        Key.F9 => (0x43, false), Key.F10 => (0x44, false), Key.F11 => (0x57, false), Key.F12 => (0x58, false),
        Key.A => (0x1E, false), Key.B => (0x30, false), Key.C => (0x2E, false), Key.D => (0x20, false),
        Key.E => (0x12, false), Key.F => (0x21, false), Key.G => (0x22, false), Key.H => (0x23, false),
        Key.I => (0x17, false), Key.J => (0x24, false), Key.K => (0x25, false), Key.L => (0x26, false),
        Key.M => (0x32, false), Key.N => (0x31, false), Key.O => (0x18, false), Key.P => (0x19, false),
        Key.Q => (0x10, false), Key.R => (0x13, false), Key.S => (0x1F, false), Key.T => (0x14, false),
        Key.U => (0x16, false), Key.V => (0x2F, false), Key.W => (0x11, false), Key.X => (0x2D, false),
        Key.Y => (0x15, false), Key.Z => (0x2C, false),
        Key.D0 => (0x0B, false), Key.D1 => (0x02, false), Key.D2 => (0x03, false), Key.D3 => (0x04, false),
        Key.D4 => (0x05, false), Key.D5 => (0x06, false), Key.D6 => (0x07, false), Key.D7 => (0x08, false),
        Key.D8 => (0x09, false), Key.D9 => (0x0A, false),
        Key.Space => (0x39, false), Key.Tab => (0x0F, false), Key.Enter => (0x1C, false),
        Key.Escape => (0x01, false), Key.Back => (0x0E, false),
        Key.Up => (0x48, true), Key.Down => (0x50, true), Key.Left => (0x4B, true), Key.Right => (0x4D, true),
        Key.Home => (0x47, true), Key.End => (0x4F, true), Key.PageUp => (0x49, true), Key.PageDown => (0x51, true),
